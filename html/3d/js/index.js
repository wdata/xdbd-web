(function(){
    $("#title>.icon").click(function(){
        console.log(this);
        console.log($(".layer_"+$(this).attr("type")));
        $("#"+$(this).attr("type")).show();
        if($(this).attr("type")=="one"){
            ...
            //map("four_map");
            four_map("four_map");
        }else if($(this).attr("type")=="five"){
            //第五张大图
            line("line_five");
            barX("bar_five");
            pei_five("pei_five");
        }else if($(this).attr("type")=="six"){
            //第六张大图
            rose("pie6");
            barY("bar6");
            bar_six("barX6");
    ...
    $(".banner a").click(function(){
        if(!$(this).hasClass("active")){
            $(".title ."+$(".banner .active").attr("type")).removeClass("on");
            $(".title ."+$(".banner .active").attr("type")).addClass("off");
            $(".banner .active").removeClass("active");
            $(this).addClass("active");
            $(".title ."+$(this).attr("type")).removeClass("off");
            $(".title ."+$(this).attr("type")).addClass("on");
...
function barY(id){
    ...
    var option = {
        ...
        yAxis : [
            {
                type : 'category',
                data : ['纳税人状态','登记注册类型','税种','增值税纳税人类型','行业','重点纳税人'],
                axisTick: {
                    show: false
                },
                axisLabel: {
        ...
        series : [
            {
                //name:'2011年',
                type:'bar',
                data:[64.5, 21.5, 14.5, 9.5, 6, 8],
                itemStyle: {
                    normal: {
                        color: new echarts.graphic.LinearGradient(
                            0, 0, 1, 0,
                            [
                                {offset: 0, color: '#052c9b'},
                                {offset: 0.5, color: '#0444a4'},
                                {offset: 1, color: '#0242d2'}
                            ]
                        )
                    },
                    /*emphasis: {
                ...
                label : {
                    normal:{show: true,color:"#fcfcfc",fontSize:"14",position:'right'}
                }
            }
        ]
    };
...
function pei(id){
    var option = {
        ...
        legend: {
            ...
            top : '40%',
            orient: 'vertical',
            data:['应申报的总户数','已申报的户数','已申报的税额','应申报未申报户数'],
            textStyle: {
                 color: '#fcfcfc'
            }
        },
        ...
        color:['#f86464', '#fa9022','#19dd73','#8c70f8'],
        calculable : true,
        series : [
            {
                type:'pie',
            ...
            },
            {
                ...
                data:[
                    {value:30, name:'应申报的总户数'},
                    {value:42, name:'已申报的户数'},
                    {value:10, name:'已申报的税额'},
                    {value:18, name:'应申报未申报户数'}
                ]
            }
        ]
    };
       ...
       /* title: {
        ...
        series: [
             { // For shadow
                type: 'bar',
                itemStyle: {
                    normal: {color: 'rgba(0,156,255,0.2)'}
                },
                barGap:'-100%',
                barCategoryGap:'40%',
                data: dataShadow,
...
// zlevel 为 1 的层开启尾迹特效
    ...
    data = normalizeData(nutrients).slice(0, 1000);
...
function bar2(id){
    ...
    option = {
        ...
        xAxis: [{
            ...
            axisLine:{
                lineStyle:{color:'#fcfcfc'}
            },
            splitLine:{show: true,lineStyle:{color:'rgba(200,200,200,.2)'}}//网格线
        }],
        yAxis: [{
            type: 'value',
            axisLabel: {
...
function four_map(id){
    ...
    var getCoord = function(params, api, lngIndex, latIndex) {
...
function pie_four(id){
    //app.title = '极坐标系下的堆叠柱状图';

    option = {
        color:['#f86464','#fa9022', '#8c70f8', '#d48265', '#91c7ae','#749f83',  '#ca8622', '#bda29a','#6e7074', '#546570', '#c4ccd3'],
        angleAxis: {
            axisLine:{
                lineStyle:{
                    color:'#fff'
