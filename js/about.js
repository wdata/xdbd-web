$(document).ready(function() {
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.952839,22.553739);//定义一个中心点坐标
    ...
    function createIcon(json){
        var icon = new BMap.Icon("http://api0.map.bdimg.com/images/blank.gif", new BMap.Size(json.w,json.h),{imageOffset: new BMap.Size(-json.l,-json.t),infoWindowOffset:new BMap.Size(json.lb+5,1),offset:new BMap.Size(json.x,json.h)})
        return icon;
    }
    initMap();//创建和初始化地图
