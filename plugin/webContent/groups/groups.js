...
// $(function () {
	...
	function initFromTable() {
		...
		if (grtoupTable != null && grtoupTable != '') {
			...
			$.each(fields.extractFields, function () {
				optionsHtml += "<option value=" + this.field + ">" + this.alias + "</option>";
			});
	...
	function set_extractFields(extractFields) {
		var extractFieldHtml = $('.groupField').prop('outerHTML');
		$('.groupField').remove();
		...
		$.each(extractFields, function () {
			...
			var extractField = $('.groupField:last');
			// extractField.find('.table').val(table);
			extractField.find('.table option[value="'+table+'"]').attr("selected","selected");
			extractField.find('.field option[value="'+field+'"]').attr("selected","selected");
			extractField.find('.alias option[value="'+alias+'"]').attr("selected","selected");
			extractField.find('.fn option[value="'+fn+'"]').attr("selected","selected");
