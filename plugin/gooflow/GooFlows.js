...
//初始化区域图的对象
	...
	this.$bgDiv.append("<div class='GooFlow_work' style='width:"+(width-14)+"px;height:"+(height)+"px;"+(property.haveHead? "":"margin-top:3px")+"'></div>");
	this.$workArea=$("<div class='GooFlow_work_inner' style='width:"+(width-14)+"px;height:"+(height-10)+"px'></div>")
...
GooFlow.prototype={
    ...
    this.$workArea.delegate(".GooFlow_item","mouseup",{inthis:this},function(e){
      ...
      if(lineStart&&!This.$mpTo.data("p")){
        ...
        var toType = This.$nodeData[this.id].type;
        var toId = this.id;
